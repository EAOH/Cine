<%-- 
    Document   : PrincipalG
    Created on : 11-26-2020, 07:56:48 AM
...
<%    if(session.getAttribute("Puesto")!=null){
        ...
        if(request.getParameter("Grafico")!=null){
            Direccion="Graficas.jsp?Grafico="+request.getParameter("Grafico");
        }
        if(request.getParameter("Accion")!=null){
            Direccion="XML.jsp?Accion="+request.getParameter("Accion");
        }
        %>
    ...
    <body>
        <div id="mySidenav" class="sidenav">
            <a style="color: white;">Reportes:</a>
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
            <a href="PrincipalE.jsp?Grafico=Sala">Sala</a>
            <a href="PrincipalE.jsp?Grafico=Pelicula">Pelicula</a>
            <a href="PrincipalE.jsp?Grafico=Horario">Horario</a>
            <a href="PrincipalE.jsp?Grafico=Sucursal">Sucursal</a>
            <a href="PrincipalE.jsp?Grafico=Compañia">Compañia</a>
            <a href="PrincipalE.jsp?Accion=Exportar">Exportar</a>
            <a href="PrincipalE.jsp?Accion=Importar">Importar</a>
